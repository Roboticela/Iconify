...
export default function PreviewContainer({ selectedImage }: PreviewContainerProps) {
  ...
  return (
    <motion.div
      ...
      className="h-full min-h-[400px] lg:min-h-0 w-full max-w-none bg-card/40 backdrop-blur-md rounded-xl transition-all duration-300 ease-in-out overflow-hidden flex flex-col p-4 max-h-full"
    >
